...
const creds = new msRest.ApiKeyCredentials({ inHeader: { 'Ocp-Apim-Subscription-Key': QnA_subscription_key } });
...
export const createKnowledgeBase = async(qbname = 'QnA Tester', urls = ['https://codekavya.blob.core.windows.net/pdfs/cpp.txt']) => {
    ...
    try {
        ...
        const operationResult = await wait_for_operation(qnaMakerClient, results.operationId)
